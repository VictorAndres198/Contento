...
export default function CustomCard({ imageSrc, title, description, buttonText, linkTo, order, backgroundColor,hidden,boxShadow, height}) {
    ...
    style={{ backgroundColor: backgroundColor,boxShadow:boxShadow }} >
      <div className="bg-transparent border-0 h-max rounded-3xl text-blue-800 pt-7  md:w-10/12 mx-8 md:mx-auto">
        <h1 className="font-bold pl-4 md:pl-12 text-teal-400">{title}</h1>
        ...
        <div>
          ...
          <div className="pl-4 md:pl-12" style={{display:hidden?"none":"block"}}>
            <Link to={linkTo}>
              <button className="rounded-3xl p-3 font-medium mt-6 mb-8 mx-auto md:w-32 lg:w-48 w-48 text-blue-800 border border-blue-800 bg-white 
      ...
      <div className="border-0 h-full md:max-w-lg md:w-full mx-auto w-96" style={{order:order}}>
